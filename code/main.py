...
from models import ResNet, DenseNet, InceptionV3, VGGModel
...
def parse_args():
    ...
    parser.add_argument(
        ...
        training with ResNet (1), DenseNet (2), VGG (3), or Inception V3 (4).''')
    parser.add_argument(
        '--data',
...
def train(model, datasets, checkpoint_path, logs_path, init_epoch):
    ...
    print('~~~~~~~~~~~ HERE 3: ',datasets.data_path,'~~~~~~~~~~~~~')
    # Begin training
    model.fit(
...
def main():
    ...
    if ARGS.task == '1':
        ...
        checkpoint_path = "checkpoints" + os.sep + \
            "res_net" + os.sep + timestamp + os.sep
        ...
        model(tf.keras.Input(shape=(hp.img_size, hp.img_size, 3)))
        checkpoint_path = "checkpoints" + os.sep + \
            "dense_net" + os.sep + timestamp + os.sep
        logs_path = "logs" + os.sep + "densenet_model" + \
            os.sep + timestamp + os.sep
        ...
        model(tf.keras.Input(shape=(hp.img_size, hp.img_size, 3)))
        checkpoint_path = "checkpoints" + os.sep + \
            "inceptionv3_net" + os.sep + timestamp + os.sep
        logs_path = "logs" + os.sep + "inceptionv3_model" + \
            os.sep + timestamp + os.sep
